...
if __name__ == '__main__':
    # 读取图像
    image_path = "D:\VS Code\Coding\CV\Group - Assignment\Apple.jpg" # 请根据自己的图像路径替换
    segmented_image, edges = preprocess_image(image_path)
    img_hsv = cv2.cvtColor(segmented_image, cv2.COLOR_HSV2BGR)
    is_rot = detect_rot(img_hsv)  # 检测腐烂
    if is_rot:
        print("水果腐烂")
    else:
        print("水果未腐烂")
